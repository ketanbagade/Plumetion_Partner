package com.example.plumetion_partner.fragment;
...
import com.example.plumetion_partner.activity.MainActivity;
...
public class RegistrationFragment extends Fragment {
    ...
    public void registerUser() {
        ...
        String mob_nunmber = phoneInput.getText().toString();
        ...
        if (TextUtils.isEmpty(name)){
            ...
            Call<User> userCall = MainActivity.serviceApi.doRegistration(name, email_id, mob_nunmber, password);
